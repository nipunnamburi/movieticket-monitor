...
export async function broadcastEvent(payload: any) {
  try {
...
export function isWithinTimeWindow(timeStr: string, from?: string | null, to?: string | null): boolean {
...
export function applyFilters(shows: SnapshotShows, monitor: any): SnapshotShows {
...
export function countTotalShows(shows: SnapshotShows): number {
  let count = 0;
...
export async function processMonitorPoll(monitorId: string, isManual = false, redisClient?: Redis) {
